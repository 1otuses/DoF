...
class SimpleSpread(PettingZooBase):
    ...
    def __init__(
        ...
        """
        # self._environment = simple_spread_v3.parallel_env(
        #     render_mode="rgb_array", continuous_actions=True
        # )
        self._environment = simple_spread_v3.parallel_env(render_mode="rgb_array")
        ...
        self._done = False
        self.environment_label = "pettingzoo/simple_spread"
    ...
    def _add_zero_obs_for_missing_agent(self, observations):
        for agent in self._agents:
            if agent not in observations:
                observations[agent] = np.zeros((18,), "float32")
        return observations
    ...
    def extra_spec(self) -> Dict[str, specs.BoundedArray]:
        ...
        """
        state_spec = {"s_t": np.zeros((54,), "float32")}  # four stacked frames
